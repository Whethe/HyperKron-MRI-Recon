...
def calculate_psnr_single(img1, img2, border=0, data_range=None):
    ...
    # gt recon
    return skimage.metrics.peak_signal_noise_ratio(img1, img2, data_range=data_range)


def calculate_psnr_case(gt, pred):

    return skimage.metrics.peak_signal_noise_ratio(gt, pred, data_range=gt.max())
...
def calculate_ssim_single(img1, img2, border=0, data_range=None):
    # img1 = img1.squeeze()
    # img2 = img2.squeeze()
    if not img1.shape == img2.shape:
        raise ValueError('Input images must have the same dimensions.')
    ...
    return skimage.metrics.structural_similarity(img1, img2, data_range=data_range)



def calculate_ssim_case(gt, pred):
